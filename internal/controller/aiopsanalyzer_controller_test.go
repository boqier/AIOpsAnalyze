...
var _ = Describe("AIOpsAnalyzer Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind AIOpsAnalyzer")
			err := k8sClient.Get(ctx, typeNamespacedName, aiopsanalyzer)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance AIOpsAnalyzer")
